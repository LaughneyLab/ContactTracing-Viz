...
app = Dash(__name__,
           ...
           meta_tags=[
               ...
               {'name': 'twitter:description', 'content': 'ContactTracing, a new method to interrogate cell-cell interactions and their biological effects from single-cell data.'},
               {'name': 'twitter:title', 'content': 'ContactTracing Visualizer'},
                {'name': 'twitter:image', 'content': 'http://contacttracing.laughneylab.com/assets/ct_cover.jpg'},
           ],
